...
// sensible defaults for most motors with fresh battery
int a_start = 40;
int b_start = 40;
...
float Kd_oppie = 0.0;
float Ki_oppie = 0.0;
// can't cheat by looking at the defaults :p
...
ISR(TIMER1_COMPA_vect)
{
  ...
  // prevent motors from moving if too close to groud
